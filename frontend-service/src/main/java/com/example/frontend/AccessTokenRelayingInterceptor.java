...
public class AccessTokenRelayingInterceptor implements ClientHttpRequestInterceptor {
  ...
  private OAuth2AuthorizedClient getAuthorisedClient() {
    ...
    return oAuth2AuthorizedClientRepository.loadAuthorizedClient(oAuth2AuthenticationToken.getAuthorizedClientRegistrationId(), oAuth2AuthenticationToken, requireNonNull(requestAttributes).getRequest());
  }
}
